    ...
    try {
      const { value } = await (0, import_provider_utils5.getFromApi)({
        ...
        failedResponseHandler: (0, import_provider_utils5.createJsonErrorResponseHandler)({
          ...
          errorToMessage: (data) => {
            var _a10;
            return (_a10 = (0, import_provider_utils5.getErrorMessage)(data)) != null ? _a10 : "unknown error";
          }
        }),
    ...
    try {
      ...
      const { value } = await (0, import_provider_utils6.getFromApi)({
        ...
        failedResponseHandler: (0, import_provider_utils6.createJsonErrorResponseHandler)({
          ...
          errorToMessage: (data) => {
            var _a10;
            return (_a10 = (0, import_provider_utils6.getErrorMessage)(data)) != null ? _a10 : "unknown error";
          }
        }),
        fetch: this.config.fetch
      });
    ...
    try {
      ...
      const { value } = await (0, import_provider_utils7.getFromApi)({
        ...
        failedResponseHandler: (0, import_provider_utils7.createJsonErrorResponseHandler)({
          ...
          errorToMessage: (data) => {
            var _a10;
            return (_a10 = (0, import_provider_utils7.getErrorMessage)(data)) != null ? _a10 : "unknown error";
          }
        }),
        fetch: this.config.fetch
      });
    ...
    try {
      const {
        ...
        failedResponseHandler: (0, import_provider_utils8.createJsonErrorResponseHandler)({
          ...
          errorToMessage: (data) => {
            var _a10;
            return (_a10 = (0, import_provider_utils8.getErrorMessage)(data)) != null ? _a10 : "unknown error";
          }
        }),
    ...
    try {
      const {
        ...
        failedResponseHandler: (0, import_provider_utils10.createJsonErrorResponseHandler)({
          ...
          errorToMessage: (data) => {
            var _a11;
            return (_a11 = (0, import_provider_utils10.getErrorMessage)(data)) != null ? _a11 : "unknown error";
          }
        }),
        ...abortSignal && { abortSignal },
        fetch: this.config.fetch
...
// src/version.ts
var VERSION = true ? "2.0.147" : "0.0.0-test";
