...
declare abstract class GatewayError extends Error {
    ...
    constructor({ message, statusCode, cause, isRetryable, }: {
        message: string;
        statusCode?: number;
        cause?: unknown;
        isRetryable?: boolean;
...
declare class GatewayResponseError extends GatewayError {
    ...
    constructor({ message, statusCode, response, validationError, cause, isRetryable, }?: {
        message?: string;
        statusCode?: number;
        response?: unknown;
