    ...
    try {
      const { value } = await getFromApi({
        ...
        failedResponseHandler: createJsonErrorResponseHandler({
          ...
          errorToMessage: (data) => {
            var _a10;
            return (_a10 = getErrorMessage(data)) != null ? _a10 : "unknown error";
          }
        }),
    ...
    try {
      ...
      const { value } = await getFromApi2({
        ...
        failedResponseHandler: createJsonErrorResponseHandler2({
          ...
          errorToMessage: (data) => {
            var _a10;
            return (_a10 = getErrorMessage2(data)) != null ? _a10 : "unknown error";
          }
        }),
        fetch: this.config.fetch
      });
    ...
    try {
      ...
      const { value } = await getFromApi3({
        ...
        failedResponseHandler: createJsonErrorResponseHandler3({
          ...
          errorToMessage: (data) => {
            var _a10;
            return (_a10 = getErrorMessage3(data)) != null ? _a10 : "unknown error";
          }
        }),
        fetch: this.config.fetch
      });
    ...
    try {
      const {
        ...
        failedResponseHandler: createJsonErrorResponseHandler4({
          ...
          errorToMessage: (data) => {
            var _a10;
            return (_a10 = getErrorMessage4(data)) != null ? _a10 : "unknown error";
          }
        }),
    ...
    try {
      const {
        ...
        failedResponseHandler: createJsonErrorResponseHandler5({
          ...
          errorToMessage: (data) => {
            var _a11;
            return (_a11 = getErrorMessage5(data)) != null ? _a11 : "unknown error";
          }
        }),
        ...abortSignal && { abortSignal },
        fetch: this.config.fetch
    ...
    try {
      const {
        ...
        failedResponseHandler: createJsonErrorResponseHandler6({
          ...
          errorToMessage: (data) => {
            var _a11;
            return (_a11 = getErrorMessage6(data)) != null ? _a11 : "unknown error";
          }
        }),
        ...abortSignal && { abortSignal },
        fetch: this.config.fetch
