...
function getRetryDelayInMs({
  ...
  const headers = import_provider6.APICallError.isInstance(error) ? error.responseHeaders : import_provider6.APICallError.isInstance(error.cause) ? error.cause.responseHeaders : void 0;
  if (!headers)
...
async function _retryWithExponentialBackoff(f, {
  ...
  try {
    ...
    if (error instanceof Error && (import_provider6.APICallError.isInstance(error) && error.isRetryable === true || import_gateway.GatewayError.isInstance(error) && error.isRetryable === true) && tryNumber <= maxRetries) {
