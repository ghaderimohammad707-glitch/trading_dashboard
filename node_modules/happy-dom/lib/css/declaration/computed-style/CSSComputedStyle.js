...
export default class CSSComputedStyle {
    ...
    getComputedStyle() {
        ...
        while (styleAndElement.element) {
            ...
            else if (styleAndElement.element[PropertySymbol.nodeType] === NodeTypeEnum.elementNode &&
        ...
        for (const parentElement of parentElements) {
            ...
            for (const { name, value, important } of rules) {
                if (CSSComputedStyleInheritedProperties[name] || parentElement === targetElement) {
